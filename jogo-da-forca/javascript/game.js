...
document.onkeyup = function (event) {
	if (!glPressStartKey) {
		...
		if (isletterinWord(event.key, glHangmanWord) !== -1) {
			if (winCondition()) {
				glScore++;
				document.getElementById("hangman-card").innerHTML = '<img id="hangman-image" class="card-img-top w-25 mx-auto" src="images/you-win.gif" alt="Card image cap">' +
					'<div class="card-body">' +
...
function init() {
	...
	document.getElementById("hangman-col").innerHTML = '<div id="hangman-card" class="card lg-mx-auto text-center lg-mt-5 bg-secondary pb-2">' +
		'<img id="hangman-image" class="card-img-top w-25 mx-auto" src="images/hangman1.png" alt="Card image cap">' +
		'<div class="card-body">' +
		'<h1 id="underlines" class="card-text"></h1>' +
		'<h4 class="card-text mt-5">Letras Erradas:</h4>' +
...
function hangmanPicChange() {
	...
	if (glHangmandCount == 1) {
		document.getElementById("hangman-image").src = "images/hangman2.png";
	}
	if (glHangmandCount === 2) {
		document.getElementById("hangman-image").src = "images/hangman3.png";
	}
	if (glHangmandCount === 3) {
		document.getElementById("hangman-image").src = "images/hangman4.png";
	}
	if (glHangmandCount === 4) {
		document.getElementById("hangman-image").src = "images/hangman5.png";
	}
	if (glHangmandCount === 5) {
		document.getElementById("hangman-image").src = "images/hangman6.png";
	}
	if (glHangmandCount === 6) {
		document.getElementById("hangman-image").src = "images/hangman7.png";
	}
	if (glHangmandCount === 7) {
		document.getElementById("hangman-image").src = "images/game-over.gif";
